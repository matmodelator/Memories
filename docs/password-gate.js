...
document.addEventListener("DOMContentLoaded", function () {
  ...
  document.getElementById("password-gate-title").style.marginBottom = "14px";
  document.getElementById("password-gate-title").style.fontSize = "20px";
  document.getElementById("password-gate-title").style.color = "#fff";
  ...
  // запрет всплытия, чтобы другие скрипты не убивали окно
  function stopAll(e) {
    e.stopPropagation();
  }
